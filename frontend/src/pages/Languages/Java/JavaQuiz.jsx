...
import ModuleBar from "../../../components/JvModuleBar"; // Sidebar module navigation
import questions from "./JvQuizQuestions.json"; // Quiz questions imported from JSON file
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <main className="flex-1 bg-gray-100 p-8 overflow-auto">
        ...
        <div className="mt-6 flex justify-between">
          ...
          <PageButton url={`/${student_id}/javaex1`} text="Next" />
        </div>

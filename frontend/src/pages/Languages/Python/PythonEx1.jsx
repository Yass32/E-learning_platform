  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="flex flex-col w-3/5 p-8 overflow-y-auto">
        ...
        <p className="text-gray-700 text-sm">Create a function named <code>same_name()</code> that has two parameters named <code>your_name</code> and <code>my_name</code>. If our names are identical, return <code>True</code>. Otherwise, return <code>False</code>.</p>

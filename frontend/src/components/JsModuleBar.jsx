                    ...
                    <div className={`overflow-hidden transition-all duration-300 ease-in-out ${open ? 'max-h-40' : 'max-h-0'}`} >
                        <div className="ml-4">
                            <ul>
                                ...
                                <Link to={`https://e-learning-platform-client.onrender.com/${student_id}/jsquizpage`}>Quiz</Link>
                                </li>
                                <li className="py-1 px-2 hover:bg-gray-600">
                                <Link to={`https://e-learning-platform-client.onrender.com/${student_id}/javascriptex1`}>Exercises</Link>
                                </li>
                            </ul>
                        </div>
                    </div>

...
const ModuleBar = () => {
    ...
    const [open, setOpen] = useState(pathname.includes("jsquizpage") || pathname.includes("javascriptex"));
    ...
    const [completedLessons] = useState(() =>
        JSON.parse(localStorage.getItem(`completedLessons_${student_id}_${JAVASCRIPT_COURSE_ID}`)) || []
    );
        ...
        <div className="w-[22%] shrink-0">
            ...
            <div className="w-[22%] h-screen bg-ink-950 text-cloud flex flex-col fixed overflow-y-auto border-r border-white/5">
                <div className="flex items-center gap-2 p-4 border-b border-white/10">
                    ...
                    <span className="font-semibold text-sm text-mist">JavaScript Course</span>
                </div>
                ...
                <div className="flex-1 py-2">
                    ...
                    <div>
                        ...
                        <div className={`overflow-hidden transition-all duration-300 ease-in-out ${open ? 'max-h-40' : 'max-h-0'}`}>
                            {[
                                { label: "Quiz", to: `/${student_id}/jsquizpage` },
                                { label: "Exercises", to: `/${student_id}/javascriptex1` },
                            ].map((item) => {
